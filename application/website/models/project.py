occ = {
    ...
    'meta_description': 'OMBU designed and built a sleek, modern, '
                        'mobile-friendly and easy-to-navigate website for the '
                        'Oregon Convention Center.',
    'visit_url': 'https://www.oregoncc.org/',
    'visit_text': 'Visit Website',
    'hero_carousel_content_template':
        'content/project/hero-carousels/_occ.html',
    'intro': '<h6>Making the World’s Most Useful Convention Center '
             'Website</h6><p>The Oregon Convention Center is a prominent '
             'institution of the West Coast, one of only two LEED Platinum '
    ...
    'testimonial_image': 'website/images/project-images/occ/aerial-photo@2x'
                         '.png',
    'testimonial_image_alt': 'An aerial photo of the Oregon Convention Center',
    'testimonial_quote': 'The OCC website is our front door and delivers '
...
kaufmanhall = {
    ...
    'meta_description': 'Kaufman Hall came to OMBU to create a unified web '
                        'presence with an enterprise content management '
                        'system to support their growth and thought '
                        'leadership.',
    'hero_carousel_content_template':
        'content/project/hero-carousels/_kaufmanhall.html',
    'intro': '<h6>Powering the Enterprise</h6><p>Kaufman Hall is a management '
             'consulting and enterprise software company with clients around '
             'the globe. After expanding their business by acquiring the '
             'leading software provider in their field, Kaufman Hall needed a '
             'unified web presence with an enterprise content management '
             'system (CMS) to support their growth and thought '
...
nwcouncilrtf = {
    ...
    'visit_text': 'Visit Website',
    'services': ['Technology Strategy', 'User Experience Design',
                 'Visual Design', 'Enterprise Drupal CMS',
                 'Accessibility Compliance Audit', 'Migration of Measures',
                 'Training'],
    'technologies': ['Enterprise Drupal CMS',
                     'Box Integration for CMS Asset Library',
                     'Searchable Measure List with Update History',
...
metro = {
    ...
    'visit_text': 'Visit Website',
    'services': ['Technology Strategy', 'Content Management Architecture',
                 'Drupal CMS Development',
                 'Government Systems Integration', 'Training & Rollout'],
    'technologies': ['Enterprise Drupal CMS', 'Publishing Moderation System',
                     'Translation/Localization for 13 Languages',
                     'Responsive Design', 'Rich Interactive Maps',
                     'Integration with Government Systems',
                     'Apache Solr Faceted Search', 'Searchable PDF Documents'],
    'url': '/work/metro',
}
...
metropcmt = {
    ...
    'intro': '<h6>Engaging the Public with Interactive Maps</h6><p>Metro '
             ...
             'design project plans and comment points on a modern mapping '
             'platform, and request comments from the public on routes and '
             'points through comment forms and rich media.</p>',
    # 'visit_url': 'http://oregonmetro.gov/swcorridormap',
    # 'visit_text': 'Visit Website',
    'services': ['User Experience Design', 'Visual Design',
                 'Drupal Application Development',
                 'Interactive Map Application Development'],
    'url': '/work/metro-pcmt',
}
...
stand = {
    ...
    'meta_description': 'To transform how Stand for Children engage with '
                        'volunteers OMBU to develop a tablet volunteer '
                        'organizing app with a Salesforce backend.',
    'hero_carousel_content_template':
        'content/project/hero-carousels/_stand.html',
    'intro': '<h6>Empowering Community Organizers to Effect Change for '
    ...
    'technologies': ['Angular JavaScript Application',
                     'Real-time Salesforce Integration', 'Touch-centric UI'],
...
compliancenext = {
    ...
    'meta_description': 'To help NAVEX Global establish leadership in their '
                        'field, OMBU built the world’s first community-driven '
...
smithsonian = {
    ...
    'meta_description': 'The Smithsonian Institute needed a bold website to '
                        'represent the forward-thinking identity of their '
                        'Lemelson Center for Invention and Innovation.',
    'hero_carousel_content_template':
        'content/project/hero-carousels/_smithsonian.html',
    'intro': '<h6>An Innovative Website for the Museum of '
             ...
             'faceted search, branded audio and video players, and fun '
             'on-page interactive elements to increase visitor '
    ...
    'services': ['Technology Strategy', 'Content Management Architecture',
                 ...
                 'Archive Records Migration', 'Government Systems Integration',
                 'Training and Rollout'],
    'technologies': ['Enterprise Drupal CMS', 'Custom Video and Audio Players',
                     'Migration of 1700+ Archive Records',
                     'Apache Solr Faceted Search',
                     'Interactive Canvas Drawing Functionality',
                     '“Surprise Me” Exploration Feature'],
    'url': '/work/smithsonian',
}

# seri = {
#   'client': 'Sustainable Electronics Recycling International',
#   'title': 'Project profile for Sustainable Electronics Recycling
#   International’s website redesign',
#   'meta_description': '',
#   'hero_carousel_content_template':
#   'content/project/hero-carousels/_seri.html',
...
#   'meta_description': '',
#   'hero_carousel_content_template':
#   'content/project/hero-carousels/_autodesk.html',
#   'url': '/work/autodesk',
# }
